...
import TotalGuestContext from "./context/TotalGuestsContext";
    ...
    <>
      <StaysContext.Provider value={stays}>
        <LocationSelectedContext.Provider value={locationSelected}>
          <TotalGuestContext.Provider value={{ totalGuests, setTotalGuests }}>
            <ToggleShowContext.Provider value={{ isShowAll, setIsShowAll }}>
